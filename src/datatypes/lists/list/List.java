...
public class List {
    ...
    public static void main(String[] args) {
        ...
        heroes.add("Hulk");
        heroes.add("Thor");
        System.out.println("Heroes datatypes.lists.list: " + heroes);
        System.out.println();
        ...
        System.out.println("Heroes datatypes.lists.list contains avengers: " + heroes.containsAll(avengers));
        System.out.println();

        // Copy
        java.util.List<String> copyList = new ArrayList<>(heroes); // Fresh copy
        System.out.println("Copy datatypes.lists.list: " + copyList);
        System.out.println();

        // Remove
        java.util.List<String> listToRemove = new ArrayList<>(heroes.subList(0, 3));
        System.out.println("listToRemove datatypes.lists.list: " + listToRemove);
        listToRemove.removeAll(avengers); // Removes EXACT objects
        System.out.println("listToRemove datatypes.lists.list without avengers: " + listToRemove);
        System.out.println();
