...
public class Array {
    ...
    public static void main(String[] args) {
        // Arrays vs Lists
        // Arrays are more efficient, but datatypes.lists automatically allocates more space.
        System.out.println("\nArrays vs Lists");
        ...
        Integer[] b = new Integer[5]; // Initialized to point to an datatypes.array
        // The references inside the datatypes.array are automatically initialized to null
        ...
        d = a; //Now d and a are pointing to the same datatypes.array
        System.out.println(Arrays.toString(d));
        ...
        // The toArray() method without passing any argument returns Object[]. So you have to pass an datatypes.array
        // as an argument, which will be filled with the data from the datatypes.lists.list, and returned
        // Due to JVM optimizations, using new String[0] is better than new String[datatypes.lists.list.size()]
